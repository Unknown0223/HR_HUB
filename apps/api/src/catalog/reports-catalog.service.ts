...
import { DayStatus, PayrollLineType, Prisma, WorkScheduleKind } from '@prisma/client';
import { PrismaService } from '../prisma/prisma.service';
import { parseDateParam, parseYearMonth, startOfCurrentMonth } from '../common/date-range';
import {
  isDayOffByPattern,
...
ORDER BY pp.month;`,
  ...
  async divisionExpensesReport(
    ...
    // Plan days = calendar days in month excluding Sundays (Arena-style)
