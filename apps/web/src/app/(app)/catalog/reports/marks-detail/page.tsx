    ...
    <div className={arena.page}>
      ...
      <div className={shared.pageHeader}>
        ...
        <div className={shared.pageHeaderText}>
          ...
          <p className={shared.pageSubtitle}>Детализация отметок посещений за выбранную дату: сотрудники, время и место отметки.</p>
        </div>
      </div>
                ...
                <table className={local.table}>
                  ...
                  <tbody>
                    {report.rows.length === 0 ? (
                      <tr>
                        <td className={local.empty} colSpan={14 + extras.length}>Нет данных</td>
                      </tr>
                    ) : (
                      report.rows.map((r) => (
