    ...
    <div className={arena.page}>
      <div className={arena.toolbar}>
        <div className={arena.tabsTrack}>
          <button
            type="button"
            className={tab === 'params' ? arena.tabOn : arena.tab}
      ...
      <div className={shared.pageHeader}>
        ...
        <div className={shared.pageHeaderText}>
          ...
          <p className={shared.pageSubtitle}>Затраты подразделений по дням и видам</p>
        </div>
      </div>
        ...
        <div className={arena.viewCard}>
          {busy && !report ? (
            ...
            <div className={arena.emptyState}>
              ...
              <span>Откройте вкладку «Параметры» и нажмите «Генерировать»</span>
            </div>
          ) : (
            <>
              <div className={arena.subTabs}>
                <button
                  type="button"
                  className={viewKind === 'detailed' ? arena.subTabOn : arena.subTab}
                ...
                <button
                  type="button"
                  className={viewKind === 'additional' ? arena.subTabOn : arena.subTab}
                ...
                <button
                  type="button"
                  className={viewKind === 'byDivision' ? arena.subTabOn : arena.subTab}
