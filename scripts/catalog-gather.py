"""
Gather real HR HUB Excel/CSV exports (Downloads) into data/catalog-dump/.
Source files are HR HUB reports dated 21.08.2026.
"""
...
def main() -> int:
    ...
    manifest = {
        ...
        "source": "HR HUB reports 21.08.2026 (Downloads)",
        "copied": copied,
        "counts": {
